...
class DonationResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'is_anonymous' => (bool) ($this->is_anonymous ?? false),
            'compliance_agreed' => (bool) ($this->compliance_agreed ?? false),
            ...
            'receipt_confirmed_at' => $this->receipt_confirmed_at,
            'receipt_confirmed_by' => $this->receipt_confirmed_by,
            'receipt_confirmed_by_user' => new UserResource($this->whenLoaded('receiptConfirmedBy')),
